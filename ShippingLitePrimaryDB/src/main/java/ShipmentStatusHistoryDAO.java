 ...
 */
public class ShipmentStatusHistoryDAO extends AbstractDAO<ShipmentStatusHistory> {
    public ShipmentStatusHistoryDAO(SessionFactory sessionFactory) {
        super(sessionFactory);
    }
    public void create(ShipmentStatusHistory his) {
        persist(his);
    }

    public ShipmentStatusHistory getShipmentStatusById(long id) {
        return get(id);
    }
